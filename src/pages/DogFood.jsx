    ...
    axios
      ...
      .then((response) => {
        ...
        const dogFoodProducts = response.data.filter(
          (product) => product.category === "dogfoodall"
        );
    ...
    <div>
      ...
      <div className="w-[400px] h-[500px] absolute mt-[-550px] ml-[900px] rounded-[30px]">
        <div className="ml-[-800px] mt-80">
          ...
          <b className="text-[46px] text-white">Dog Foods</b>
        </div>
      </div>
       
      <div className="flex h-44">
        <div className="mt-8 ml-10">
          <a href="/drydogfood" className="border shadow-xl border-gray-800/72 px-10 py-2  rounded-[20px]">Dry Dog Food</a>
          <a href ="/wetdogfood" className="border shadow-xl border-gray-800/72 px-10 py-2  rounded-[20px]">Wet Dog Food</a>
