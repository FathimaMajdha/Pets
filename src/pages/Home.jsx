  ...
  return (
    <>
      <div>
        ...
        {/* First part */}
        <div className="relative flex flex-col-2 items-center sm:items-start sm:w-[400px] sm:h-[600px] sm:mt-[-550px] sm:ml-[900px] sm:rounded-[30px]">
          <div className=" -mt-2 -sm:mt-20 sm:ml-[-20]">
            ...
            <button onClick={()=>{navigate('/offers')}} className="bg-gray-800 text-white  text-[16px] py-3 px-14 sm:px-14 hover:shadow-2xl rounded-[20px] cursor-pointer transition-all duration-300  sm:mt-[50px]">
              Shop Now
            </button>
          </div>
        </div>
        ...
        {/* Second part */}
        <div className="text-[24px] sm:text-[39px] p-5 sm:p-1 text-center">
          <b>Shop for</b>
      ...
      <div className="p-4 sm:p-[40px]">
        <b className="text-[24px] sm:text-[39px]">New and Featured</b>
        <div className="flex items-center mt-4 sm:mt-[20px]">
          ...
          <div
            ...
            className="flex overflow-x-auto scroll-smooth max-w-full sm:max-w-[1200px] gap-4 sm:gap-[20px]"
          >
      ...
      {/* Fourth part */}
      <div className="relative w-full sm:w-[1500px] h-[500px] bg-[#213555] rounded-[10px] overflow-hidden">
        {/* Left Side */}
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2 sm:left-[80%] top-[-10px] sm:top-[-10px] w-full sm:w-[700px] md:w-[800px] h-[550px] bg-white rounded-l-full overflow-hidden">
