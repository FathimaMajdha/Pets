...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#1B1833] text-white">
      <div className="py-10">
        <div className="container mx-auto flex flex-col md:flex-row justify-evenly gap-10 relative">
          ...
          <div className="flex-1">
            ...
            <p className="font-devonshire text-3xl mt-6">PetsFood</p>
          </div>
          ...
          <div className="flex-1 ml-60">
            ...
            <ul className="flex space-x-6 mt-8 text-xl">
